 ...
 * tetrominoes. The shapes are falling down the board.
 * </p>
 * <p>
 * The object of the Tetris game is to move and rotate the shapes, so that they fit as much as
 * possible. If we manage to form a row, the row is destroyed and we score. We play the tetris game
 * until we top out.
 * </p>
 *
 * @author Jan Bodnar
