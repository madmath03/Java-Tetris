...
public class Tetromino {
	...
	public enum Shape {
		 ...
		 */
		I(new Color(102, 204, 204), 
				new int[][] { { 2, 0 }, { 1, 0 }, { 0, 0 }, { -1, 0 } }),
		/**
		 * J-shape or MirroredL-shape.
		 */
		J(new Color(218, 170, 0), 
				new int[][] { { 1, -1 }, { 1, 0 }, { 0, 0 }, { -1, 0 } }),
		/**
		 * L-shape.
		 */
		L(new Color(102, 102, 204), 
				new int[][] { { 1, 0 }, { 0, 0 }, { -1, 0 }, { -1, -1 } }),
		/**
		 * O-shape or Square-shape.
		 */
		O(new Color(204, 204, 102), 
				new int[][] { { 0, 0 }, { 1, 0 }, { 1, 1 }, { 0, 1 } }),
		/**
		 * S-shape.
		 */
		S(new Color(102, 204, 102), 
				new int[][] { { 1, -1 }, { 0, -1 }, { 0, 0 }, { -1, 0 } }),
		/**
		 * T-shape.
		 */
		T(new Color(204, 102, 204), 
				new int[][] { { 1, 0 }, { 0, 0 }, { -1, 0 }, { 0, -1 } }),
		/**
		 * Z-shape.
		 */
		Z(new Color(204, 102, 102), 
				new int[][] { { 1, 0 }, { 0, 0 }, { 0, -1 }, { -1, -1 } });

		/**
		 * The <em>Random Generator</em> is the algorithm used to generate the
		 * sequence of tetrominoes in Tetris brand games that follow the Tetris
		 * Guideline.
		 *
		 * <p>
		 * Random Generator generates a sequence of all seven one-sided
		 * tetrominoes ({@link Shape#I}, {@link Shape#J}, {@link Shape#L},
		 * {@link Shape#O}, {@link Shape#S}, {@link Shape#T}, {@link Shape#Z})
		 * permuted randomly, as if they were drawn from a bag. Then it deals
		 * all seven tetrominoes to the piece sequence before generating another
		 * bag. There are 7!, or 5,040, permutations of seven elements.
		 * </p>
		 *
		 * @see <a href="http://tetris.wikia.com/wiki/Random_Generator">Random
		 *      Generator</a>
		 */
		 ...
		 * 
		 * @see <a href="http://tetris.wikia.com/wiki/Ghost_piece">Ghost
		 *      piece</a>
		 */
	 ...
	 * 
	 * @param another
	 *            another Tetromino to copy
	 * @throws IllegalArgumentException
	 *             if the other Tetromino is {@code null}
	 */
	Tetromino(final Tetromino another) {
		if (another == null) {
			throw new IllegalArgumentException(
					"Tetromino to copy cannot be null");
		}
		this.blocks = new int[BLOCKS][DIMENSIONS];
	 ...
	 * 
	 * <p>
	 * The Tetromino's blocks coordinates are set according the shape's default
	 * coordinates.
	 * </p>
	 * 
	 * @see #blocks
	 ...
	 * 
	 * @param shape
	 *            the new Tetromino's shape. If {@code null}, then all blocks
	 *            are set to origin.
	 */
	 ...
	 *            a given block index
	 * @param x
	 *            the new {@code X} coordinate of given block index
	 */
	 ...
	 *            a given block index
	 * @param y
	 *            the new {@code Y} coordinate of given block index
	 */
	 ...
	 *            a given block index
	 * @param dimension
	 *            a given dimension's index
	 * @param position
	 *            the new dimension's coordinate of given block index
	 */
